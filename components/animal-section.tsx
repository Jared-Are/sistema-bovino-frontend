...
interface AnimalBackend {
  ...
  madre?: { animal_id: number; nombre: string; arete: string };
  padre?: { animal_id: number; nombre: string; arete: string };
  imagen?: string;
}
...
const mapBackendToFrontend = (backend: AnimalBackend): Animal => ({
  ...
  edad: calcularEdad(backend.fecha_nacimiento),
  ...
  padre: backend.padre ? (backend.padre.nombre || backend.padre.arete) : undefined,
  madre: backend.madre ? (backend.madre.nombre || backend.madre.arete) : undefined,
  padreId: backend.padre?.animal_id?.toString() || undefined,
  madreId: backend.madre?.animal_id?.toString() || undefined,
});
